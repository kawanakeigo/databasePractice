...
COMMENT ON COLUMN cities.country_code IS '国コード';
COMMENT ON COLUMN cities.district IS '地区';
COMMENT ON COLUMN cities.population IS '人口';
...
CREATE TABLE countries (
  ...
  surface_area NUMERIC(10,2) NOT NULL DEFAULT 0.00,
  indep_year SMALLINT DEFAULT NULL,
  population INTEGER NOT NULL DEFAULT 0,
  life_expectancy NUMERIC(3,1) DEFAULT NULL,
  gnp NUMERIC(10,2) DEFAULT NULL,
  gnp_old NUMERIC(10,2) DEFAULT NULL,
...
COMMENT ON COLUMN countries.code IS '国コード';
COMMENT ON COLUMN countries.continent IS '大陸';
COMMENT ON COLUMN countries.region IS '地方';
COMMENT ON COLUMN countries.surface_area IS '表面積';
COMMENT ON COLUMN countries.indep_year IS '独立記念日';
COMMENT ON COLUMN countries.population IS '人口';
COMMENT ON COLUMN countries.life_expectancy IS '平均寿命';
COMMENT ON COLUMN countries.gnp IS '国内総生産';
COMMENT ON COLUMN countries.capital IS '資本';
...
COMMENT ON COLUMN countrylanguages.country_code IS '国コード';
...
CREATE TABLE celebrities (
  ...
  occupation CHAR(52) NOT NULL DEFAULT ''
);
COMMENT ON COLUMN celebrities.country_code IS '国コード';
COMMENT ON COLUMN celebrities.birth IS '誕生日';
COMMENT ON COLUMN celebrities.age IS '年齢';
COMMENT ON COLUMN celebrities.occupation IS '職業';
...
INSERT INTO countrylanguages VALUES
('ABW','Dutch','T',5.3),
('ABW','English','F',9.5),
